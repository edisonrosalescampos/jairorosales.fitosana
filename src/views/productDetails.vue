  ...
  <div class="container my-4 product-page">
    <div class="mb-4">
      <RouterLink :to="{ path: '/products', hash: '#' + product.category }">
        <button class="btn btn-sm custom-btn btn-back">
    ...
    <div class="row">
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <div>
          <a class="btn custom-btn btn-buy me-2" href="https://wa.link/aolufg" target="_blank">
            <i class="fas fa-shopping-cart me-1"></i> Comprar
          </a>
          <a class="btn custom-btn btn-buy" href="https://wa.link/aolufg" target="_blank">
